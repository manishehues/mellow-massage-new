...
?>
	...
	<div id="bars" class="mobile_toggle" style="display:none">
		...
		<div class="rightSide contactDetails">
			...
			<?php if(!empty($headerMenu['book_now_text'])) : ?>
				<div class="bookNow-btn">
					<a class="btn openPopup" href="<?php echo $headerMenu['book_now_link'];?>"><span class="fusion-button-text"><?php echo $headerMenu['book_now_text'];?></span></a>
				</div>
			<?php endif;?>
			<!-- <div class="bookNow-btn" style="display:none;">
				<a class="bttn fusion-button small" target="_self" href="<?php echo $headerMenu['book_now_link'];?>"><span class="fusion-button-text">Book Now </span></a>
			</div> -->			
		</div>
	</div>
</header>
